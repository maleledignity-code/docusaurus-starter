...
from ._exceptions import HhError, APIStatusError
...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "Hh", "AsyncHh", "Client", "AsyncClient"]


class Hh(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Hh client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("HH_BASE_URL")
        if base_url is None:
            base_url = f"https://petstore3.swagger.io/api/v3"

        custom_headers_env = os.environ.get("HH_CUSTOM_HEADERS")
    ...
    @cached_property
    def with_raw_response(self) -> HhWithRawResponse:
        return HhWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> HhWithStreamedResponse:
        return HhWithStreamedResponse(self)
...
class AsyncHh(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncHh client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncHhWithRawResponse:
        return AsyncHhWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncHhWithStreamedResponse:
        return AsyncHhWithStreamedResponse(self)
...
class HhWithRawResponse:
    _client: Hh

    def __init__(self, client: Hh) -> None:
        self._client = client
...
class AsyncHhWithRawResponse:
    _client: AsyncHh

    def __init__(self, client: AsyncHh) -> None:
        self._client = client
...
class AsyncHhWithStreamedResponse:
    _client: AsyncHh
